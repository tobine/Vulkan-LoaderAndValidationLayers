...
void PreCallCreateInstance(const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkInstance* pInstance);
...
void PostCallDestroyDevice(device_layer_data* device_data, VkDevice device, const VkAllocationCallbacks* pAllocator);
...
// Skipping line:VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetInstanceProcAddr(

// Skipping line:VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetDeviceProcAddr(
...
void PreCallDebugMarkerSetObjectNameEXT(device_layer_data* device_data, VkDevice device, VkDebugMarkerObjectNameInfoEXT* pNameInfo);
